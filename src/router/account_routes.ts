export default [
    {
        ...
        children: [
            { path: 'dashboard', name: 'user_Dashboard', component: () => import('../views/Account/User/Dashboard.vue') },
            { path: 'settings', name: 'user_Settings', component: () => import('../views/Account/User/Settings.vue') },
