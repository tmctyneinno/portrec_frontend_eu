            ...
            <div class="card h-100 border-0 shadow">
                <div class="card-body">
                    <div class="card-title">
                        ...
                        <primaryButton @click="subscriptionStore.openOptions" :className="'btn-sm float-end'">
                            Subscribe
                        </primaryButton>
                    ...
                    <ul class="list-group list-group-flush small">
                        <li class="list-group-item d-flex border-0" v-for="(item, index) in subscriptionStore.freePlan"
                            :key="index">
                            <div class="col-1">
                                <i class="bi bi-check2-all"></i>
                            </div>
                            <div :class="['col', !item.lineThrough ? 'fw-bold' : 'text-decoration-line-through']">
                                {{ item.desc }}
                            </div>
                        </li>
                    </ul>
            ...
            <div class="card h-100 border-0 shadow">
                <div class="card-body">
                    <div class="card-title">
                        ...
                        <primaryButton :className="'btn-sm float-end'">
                            Upgrade
                        </primaryButton>
                        <div class="text-muted small mt-3">
                        ...
                        <div class="fw-bold mt-3" style="font-size: 1.47rem;">
                            &#8358;{{ useFxn.addCommas(subscriptionStore.userPremiumPrice) }} <sub>/month</sub>
                        </div>
                    </div>
                    ...
                    <ul class="list-group list-group-flush small">
                        <li class="list-group-item d-flex border-0"
                            v-for="(item, index) in subscriptionStore.premiumPlan" :key="index">
                            <div class="col-1">
                                <i class="bi bi-check2-all"></i>
                            </div>
                            <div :class="['col', !item.lineThrough ? 'fw-bold' : 'text-decoration-line-through']">
                    ...
                    <hr>
                    <primaryButtonOutline :className="'w-100 mb-2'">
                        Try 1 month FREE
