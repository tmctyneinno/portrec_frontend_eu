<template>
  ...
  <div class="container animate__animated animate__fadeIn">
    ...
    <div class="section-panel min-vh-100 pt-5 pb-0">
      <div class="row g-3">
        ...
        <div class="col-md-12">
          ...
          <div class="">
            <p>
              Portrec Resourcing recruits’ talents across all sectors that cover talent resourcing and executive, umbrella
              company, and payroll services.
            </p>
            <p>
              You can get in touch with Portrec online or visit our offices in the UK & Africa, Lagos Nigeria. Our name is
            ...
            <p>
              ...
              Europe, and Asia. Consultants and contracts avail out lucrative services and remember us for the flexibility
              and fast turnaround.
            </p>
            <p>
    ...
    <div class="section-panel">
      ...
      <div class="row g-3">
        <div class="col-md-6">
          <img src="@/assets/images/about/process.jpg" width="100%" alt="">
        </div>
        <div class="col-md-6">
          <h5 class="fw-bold">Talent Resourcing</h5>
          <div>
            The quality and qualification of job seekers are important criteria to determine the grade of the consultancy.
            Portrec proudly presents well-learned, harnessed individuals, prepared to face the industry leaders during the
            ...
            resources from the mentors of Portrec.With this prerogative, we were successful in establishing a long-lasting
            ...
            candidate can fit in. Most of the candidates who register with us get placed in reputed organizations within a
      ...
      <div class="row g-3">
        <div class="col-md-6">
          ...
          <div>
            ...
            achieving something to perfection difficult.Our executive team is aware, agile, and influencing. Each staff of
            ...
            Why do you think so many stakeholders trust us? Because: We employ an executive search strategy, to project an
        ...
        <div class="col-md-6">
          <img src="@/assets/images/about/executive.jpg" width="100%" alt="">
        </div>
      </div>
    </div>
    ...
    <div class="section-panel" style="padding-bottom: 200px;">
      <div class="row g-3">
        <div class="col-md-6">
          <img src="@/assets/images/about/payroll.jpg" width="100%" alt="">
        </div>
        <div class="col-md-6">
          <h5 class="fw-bold">Payroll Services</h5>
          <div>
            Portrec earned its position as the fastest growing and one of the most efficient payroll outsourcing companies
            in the UK. We are versatile and offer payroll services to a small start-up as well as a corporation. First, we
